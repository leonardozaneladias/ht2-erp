---
name: state-latest
description: Return latest state or props with useLatest hook
---
...
Returns a ref object with `current` property containing latest value.

## Key Points

- Always has latest value
- Returns ref object
- Useful for async callbacks

<!--
Source references:
- https://github.com/streamich/react-use/blob/master/docs/useLatest.md
-->
