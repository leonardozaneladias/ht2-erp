...
- **Scaffolding de CRUD (2026-07-12) — não copie, consuma.** As telas de CRUD tinham 93 arquivos duplicados (`_acoes`, `_lixeira-toggle`, `_ficha`, `_export-pdf`), gerados pelos stubs do `make:modulo`. Hoje:
    ...
    - Os stubs `view-acoes`, `view-acoes-lixeira`, `view-lixeira-toggle` e `view-export-pdf` **foram removidos**: sem isso, o próximo `make:modulo` reintroduziria a duplicação.
