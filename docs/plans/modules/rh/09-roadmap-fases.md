...
| 3   | Documentos em lote (multi-arquivo + ZIP + tag) | **1** (incremento de B2; multi-upload na Fase 1; ZIP/tag = incremento 1.x) | [03 §8.5/§8.6](03-cadastro-pessoa-documentos.md)                                                                      |
