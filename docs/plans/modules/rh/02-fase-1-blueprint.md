...
> Cobertura: os 7 blocos cobrem as ≈21 tabelas do [01 §9](01-modelo-de-dominio.md) (10 catálogos tenant em B1/B3/B5/B6/B7 — inclui `fator_horas_extras` · 6 do funcionário em B2 · 2 de histórico em B4 · 1 operacional em B6 · 1 referência de folha em B7) e os 20 enums do [01 §4](01-modelo-de-dominio.md). O **grupo PCD** e o **`codCateg`** ([01 §4.1](01-modelo-de-dominio.md)) são aditivos cadastrais em B2 (colunas/método, sem tabela nova). O vínculo ACL não é tabela própria — vive em `funcionarios.admin_user_id` (B2 cria a coluna, B3 dá a mecânica).
