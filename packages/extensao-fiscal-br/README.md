...
Pacote Composer instalável que adiciona o módulo FiscalBr a qualquer
instalação de qualquer produto, sem editar o core (ver ADR-0015).

## Instalar em um cliente

```bash
composer require ht2ml/extensao-fiscal-br
...
```bash
php artisan vendor:publish --tag=fiscal-br-config
```

## Desenvolvimento

Durante o desenvolvimento o pacote vive em `packages/fiscal-br` do
