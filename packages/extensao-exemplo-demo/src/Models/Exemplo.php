...
namespace HT2ML\ExemploDemo\Models;
...
use HT2ML\ExemploDemo\Database\Factories\ExemploFactory;
...
class Exemplo extends Model implements UsaSoftDeletes
{
    ...
    /**
     * Explícito porque o resolvedor padrão monta o nome da factory a partir
     * do namespace da APLICAÇÃO — para classe de pacote, erra o alvo.
     */
    protected static function newFactory(): ExemploFactory
    {
        return ExemploFactory::new();
    }
