...
@php
    ...
    $pageTitle = app(\HT2ML\Core\Services\Admin\Settings\BrandingService::class)->tituloPagina($title);
    // Aparência/layout vinda dos settings da instância (antes fixa aqui).
    $appearance = app(\HT2ML\Core\Services\Admin\Settings\AppearanceService::class);
@endphp
