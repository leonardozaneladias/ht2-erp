        ...
        <x-shared.card title="Componentes concluídos" subtitle="Fase 6 • Batches 1, 2, 3, 4, 5, 6, 7 e 8">
            <div class="grid gap-3 sm:grid-cols-2">
                @foreach ([
                    ...
                    'reveal' => ['Entrada fade-up padrão de blocos condicionais (etapas, resultados)', 'tabler--transition-top'],
                    'stat-tile' => ['Tile de métrica com contagem animada para resultados de importação e lotes', 'tabler--chart-infographic'],
                    'step-guide' => ['Timeline vertical de instruções com ações contextuais por passo', 'tabler--list-numbers'],
                    ...
                    'field-display' => ['Rótulo + valor read-only para fichas de visualização', 'tabler--id'],
                    'ficha-drawer' => ['Drawer wide+blur da ficha "Ver" dos CRUDs (ComFicha)', 'tabler--eye'],
                    ...
                    'select-search' => ['Combobox com busca e checkbox para relacionamentos, múltiplos e agrupamentos', 'tabler--search'],
                    'color-picker' => ['Seletor de cor (swatch + hex) sobre input type=color, sem dependência', 'tabler--palette'],
                    'rich-editor' => ['Editor rich text (Quill) com toolbar mínima e sanitização no servidor', 'tabler--text-wrap'],
                    'tags-input' => ['Chips/tags com entrada livre sobre Choices.js', 'tabler--tags'],
                    ...
                    'cnpj-input' => ['CNPJ com máscara BR para empresas e configs', 'tabler--building-bank'],
                    ...
                    'masked-input' => [
                        'Base de todo campo mascarado — e os wrappers com dígito verificador',
                        'tabler--id-badge-2',
                    ],
                    ...
                    'wizard' => ['Stepper server-driven para fluxos multi-etapas (importação, cadastros longos)', 'tabler--stairs-up'],
