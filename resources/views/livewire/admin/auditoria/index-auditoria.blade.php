<div class="space-y-6">
    ...
    <x-shared.card>
        ...
        <x-admin.table.table :density="'comfortable'" data-testid="tabela-auditoria">
            <thead>
                <tr>
                    <th>Quando</th>
                    <th>Quem</th>
            ...
            <tbody>
                @forelse ($eventos as $evento)
                    <tr wire:key="evt-{{ $evento->id }}" class="hover:bg-light/40 transition-colors">
                        <td class="whitespace-nowrap">{{ $evento->created_at->format('d/m/Y H:i:s') }}</td>
                        ...
                        <td class="text-default-600">{{ $evento->description }}</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="6">
