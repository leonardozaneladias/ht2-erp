<div class="space-y-6">
    ...
    <x-shared.card>
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
            <x-shared.input name="codigo_iso2" label="Código ISO2" wire:model="codigo_iso2" required maxlength="2" />
            <x-shared.input name="codigo_iso3" label="Código ISO3" wire:model="codigo_iso3" maxlength="3" />
            <x-shared.input name="codigo_numerico" label="Código numérico" wire:model="codigo_numerico" maxlength="3" />
