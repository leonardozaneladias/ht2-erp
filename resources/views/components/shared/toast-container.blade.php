...
<div
    {{
$attributes->class([
            'pointer-events-none fixed inset-x-0 top-4 z-[1100] flex flex-col items-center gap-2 px-4',
        ])
}}
...
>
    ...
    <template data-toast-template="pilula">
        ...
        >
            <i data-toast-icon class="iconify shrink-0 text-lg"></i>
    ...
    <template data-toast-template="card">
        ...
        >
            <i data-toast-icon class="iconify mt-0.5 shrink-0 text-xl"></i>
