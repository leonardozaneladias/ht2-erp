...
@section ('preview')
    <div class="grid gap-6 lg:grid-cols-2">
        <x-shared.card title="Demonstração" subtitle="Shell do drawer (estado vazio — sem registro)">
            <p class="text-default-500 mb-4 text-sm">Em produção o drawer é alimentado pelo trait <code class="text-xs">ComFicha</code> no Index e abre pelo evento <code class="text-xs">ficha-abrir</code> após autorizar e carregar o registro. Referência viva: <a href="{{ route('admin.exemplos.index') }}" class="text-primary hover:underline">módulo Exemplo</a> (kebab → Ver).</p>
